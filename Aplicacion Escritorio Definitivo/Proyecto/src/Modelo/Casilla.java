...
public class Casilla {
     ...
     */
    private static Map<String, Integer> tiempos;
        ...
        do {
            try {
                if (dificultad.equalsIgnoreCase("easy"))
                    pr = leerDeFichero("resources\\api" + categoria + "F.txt");
                else if (dificultad.equalsIgnoreCase("hard"))
                    pr = leerDeFichero("resources\\api" + categoria + "D.txt");
                else if (dificultad.equalsIgnoreCase("medium"))
                    pr = leerDeFichero("resources\\api" + categoria + "M.txt");
                else {
                    pr = leerDeFichero("resources\\apiSportsF.txt");
                    categoria = "General";
                    dificultad = "easy";
                }
