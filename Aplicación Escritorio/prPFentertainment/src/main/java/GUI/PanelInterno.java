...
=======
     ...
     *
     */
    static final String cmdModoDesafio = "DESAFIO",
            cmdModoRapida = "RAPIDA",
            cmdRegistraJugador = "REGISTRA",
            cmdInicioPartida = "INICIO",
            cmdEndButton = "TERMINA",
    ...
    JTextArea getTextTablero() {
        return textTablero;
    }

    JComboBox<Object> getComboBoxOpciones_1() {
        return comboBoxOpciones_1;
    }

    void addController(Controlador ctr) {
        modoDesafio.addActionListener(ctr);
        modoRapida.addActionListener(ctr);
        registraJugador.addActionListener(ctr);
        inicioPartida.addActionListener(ctr);
    ...
    JTextField getNombreJugador() {
        return nombreJugador;
    }

    JLabel getEstadoLabel() {
        return estadoLabel;
    }
    ...
    JButton getModoDesafio() {
        return modoDesafio;
    }

    JButton getModoRapida() {
        return modoRapida;
    }

    JButton getRegistraJugador() {
        return registraJugador;
    }

    JButton getInicioPartida() {
        return inicioPartida;
    }
    ...
    JButton getResponderPregunta() {
        return responderPregunta;
    }

    JButton getSeguirPartida() {
        return seguirPartida;
    }
    ...
    JComboBox<Object> getComboBoxOpciones() {
        return comboBoxOpciones;
    }
    ...
    JButton getVisualizarPregunta() {
        return iniciarPregunta;
    }

    JTextArea getTextPregunta() {
        return TextPregunta;
    }

    JTextPane getModoSeleccionado() {
        return modoSeleccionado;
    }
>>>>>>> Stashed changes
}
